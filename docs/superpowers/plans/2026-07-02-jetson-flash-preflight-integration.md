...
- (post-review, Tom's request) big orange NOT-IN-FORCED-RECOVERY banner above
  the verdict whenever the detected state isn't 7023 (incl. absent), with
  how-to-enter-recovery steps; visual only, exit codes unchanged.
